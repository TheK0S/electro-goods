...
export const Header = () => {
    return (
        <header className="grid grid-rows-2 grid-cols-12 gap-y-4 
            ...
            <div className="xs:col-span-2"><Logo /></div>
            ...
            <div className="row-start-1 col-start-6 col-span-4 xs:col-start-4"><ContactsPanel/></div>
            <div className="row-start-1 col-start-8 col-span-1 xs:col-start-8 xs:col-span-1"><IconsPanel/></div>
