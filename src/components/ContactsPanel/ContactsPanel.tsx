...
export const ContactsPanel = () => {
    ...
    return (
        <div className='contactsPanel-wrap flex text-xs items-center relative '>
            ...
            <div className="contactPanel-icon px-1  z-20" onClick={()=>showContactsPanel(!isAdditionalContactPanel)}>      
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="-8 0 38 25" strokeWidth={1.5} stroke="white" 
